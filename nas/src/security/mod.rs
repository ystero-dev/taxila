...
mod tests {
    ...
    fn test_set_2_33_401_c1() {
        ...
        assert!(
            "5961605353c64bdca15b195e288553a910632506d6200aa790c4c806c99904cf2445cc50bb1cf168a49673734e081b57e324ce5259c0e78d4cd97b870976503c0943f2cb5ae8f052c7b7d392239587b8956086bcab18836042e2e6ce42432a17105c53d0" == hex::encode(&result),
            "{}",
            hex::encode(&result)
        );
    }
    ...
    fn test_set_3_33_401_c1() {
        ...
        assert!(
            "75750d37b4bba2a4dedb34235bd68c6645acdaaca48138a3b0c471e2a7041a576423d2927287f000"
                == hex::encode(&result),
            "{}",
            hex::encode(&result)
        );
    ...
    #[test]
    fn test_set_4_33_401_c1() {
        let key = hex::decode("aa1f95aea533bcb32eb63bf52d8f831a").unwrap();
        let count = 0x72d8c671_u32;
        let bearer = 0x10_u8;
        let downlink = true;
        let payload = hex::decode(
"",)
        .unwrap();
        let bitlen = 1022;
        ...
        assert!("" == hex::encode(&result), "{}", hex::encode(&result));
    }

    #[test]
    fn test_set_5_33_401_c1() {
        let key = hex::decode("9618ae46891f86578eebe90ef7a1202e").unwrap();
        let count = 0xc675a64b_u32;
        let bearer = 0x0c_u8;
        let downlink = true;
        let payload = hex::decode(
"",)
        ...
        assert!("" == hex::encode(&result), "{}", hex::encode(&result));
    }

    #[test]
    fn test_set_6_33_401_c1() {
        let key = hex::decode("54f4e2e04c83786eec8fb5abe8e36566").unwrap();
        let count = 0xaca4f50f_u32;
        let bearer = 0x0b_u8;
        let downlink = false;
        let payload = hex::decode("").unwrap();
        let bitlen = 3861;
        ...
        assert!("" == hex::encode(&result), "{}", hex::encode(&result));
    }
