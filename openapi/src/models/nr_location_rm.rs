...
pub struct NrLocationRm {
    ...
    #[serde(rename = "globalGnbId", skip_serializing_if = "Option::is_none")]
    pub global_gnb_id: Option<Box<crate::models::GlobalRanNodeId>>,
}

impl NrLocationRm {
    /// This data type is defined in the same way as the 'NrLocation' data type, but with the OpenAPI 'nullable: true' property.\" 
    pub fn new(tai: crate::models::Tai, ncgi: crate::models::Ncgi) -> NrLocationRm {
        NrLocationRm {
            tai: Box::new(tai),
            ncgi: Box::new(ncgi),
            ignore_ncgi: None,
