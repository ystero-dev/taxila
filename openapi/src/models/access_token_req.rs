...
pub struct AccessTokenReq {
    ...
    pub requester_plmn: Option<Box<crate::models::PlmnId1>>,
    #[serde(rename = "requesterPlmnList", skip_serializing_if = "Option::is_none")]
    pub requester_plmn_list: Option<Vec<crate::models::PlmnId1>>,
    ...
    pub requester_snpn_list: Option<Vec<crate::models::PlmnIdNid1>>,
    #[serde(rename = "targetPlmn", skip_serializing_if = "Option::is_none")]
    pub target_plmn: Option<Box<crate::models::PlmnId1>>,
    #[serde(rename = "targetSnpn", skip_serializing_if = "Option::is_none")]
    pub target_snpn: Option<Box<crate::models::PlmnIdNid1>>,
